...
namespace Shop.UIClassic.Android.Activities
{
    ...
    public class LoginActivity : AppCompatActivity
    {
        ...
        private void SetInitialData()
        {
            ...
            this.emailText.Text = "leonardo_perez@hotmail.com";
        ...
        private async void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogService.ShowMessage(this, "Error", "You must enter an email.", "Accept");
                return;
            }

            if (string.IsNullOrEmpty(this.passwordText.Text))
            {
                DialogService.ShowMessage(this, "Error", "You must enter a password.", "Accept");
                return;
            }
            ...
            var response = await this.apiService.GetTokenAsync(
                "https://kseshop.azurewebsites.net",
                "/Account",
                "/CreateToken",
                request);
            ...
            {
                DialogService.ShowMessage(this, "Error", "User or password incorrect.", "Accept");
                return;
            }

            //DialogService.ShowMessage(this, "Ok", "Fuck Yeah!", "Accept");
